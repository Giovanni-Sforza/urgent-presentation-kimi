...
**the executor MUST verify the generated Mermaid code by running the Mermaid CLI (`mmdc`).**
...
After successful rendering, the executor MUST read the generated PNG and perform a STRICT review:

```markdown
## the executor's STRICT Review of <diagram-name>
